...
listTable.edit = function(obj, act, id)
{
  ...
  txt.onblur = function(e)
  {
    ...
    {
      //alert(listTable.url);return false;
...
listTable.sort = function(sort_by, ids,sort_order)
{
  var args = "act="+this.query+"&ids="+ids+"&sort_by="+sort_by+"&sort_order=";

...
<div class="form-div">
  <form action="javascript:searchOrder()" name="searchForm">
   ...
   日期<input name="sdate" type="text" id="sdate" value="<?php echo $this->_var['filter']['sdate']; ?>" onclick="javascript:WdatePicker()" readonly="true" size="10">
	...
	代金卡号<input name="card_id" type="text" value="<?php echo $this->_var['filter']['card_id']; ?>" maxlength="22" id="card_id" size="16">
...
<tr bgcolor="#ffffff" title="<?php echo $this->_var['list']['best_time']; ?>" onMouseover="this.style.backgroundColor='#e9f6f8'" onMouseout="this.style.backgroundColor=''" id="trList">
    ...
    <td align="center"><a href="more_order_info.php?order_id=<?php echo $this->_var['list']['order_id']; ?>" target="_blank">详情</a></td>
    <td align="left">
	  ...
	  <?php echo $this->_var['list']['order_sn']; ?></td>
	<td align="center"><?php echo $this->_var['list']['bonus']; ?></td>
	<td align="center"><?php echo $this->_var['list']['add']; ?><?php echo $this->_var['list']['to_buyer']; ?></td>
	<!--  <td align="left"><?php echo $this->_var['list']['asd']; ?><?php echo $this->_var['list']['to_buyer']; ?></td> 
    <td align="center" id="txt_<?php echo $this->_var['list']['order_id']; ?>"><?php if ($this->_var['list']['ctatus'] == '1'): ?>待审核<?php elseif ($this->_var['list']['ctatus'] == '2'): ?>已审核<?php else: ?>未审核<?php endif; ?></td>
	<td align="center">
 	<a href="javascript:;" onclick="return check_sg(<?php echo $this->_var['list']['order_id']; ?>,'<?php echo $this->_var['list']['order_id']; ?>')">审核订单</a></td>-->
  </tr>
  <?php endforeach; else: ?>
